  ...
  <q-page class="flex flex-center">
    <div class="flex-center" style="width: 80%">
      ...
      <q-page class="q-pa-sm q-py-xl">
        <!-- input field for city coordinates -->
        <q-input
          ref="coordInput"
          standout
          bottom-slots
          v-model="coordinates"
          label="Enter the coordinates (latitude, longitude)"
          @keyup.enter="getWeatherData"
          style="width: 80%"
          class="q-mx-auto"
        >
          <!-- button to clear input and fetched data -->
...
export default defineComponent({
  ...
  methods: {
    ...
    async getWeatherData() {
      try {
        // getting coordinates from the input field
    ...
    clearField() {
      ...
      this.$refs.coordInput.focus(); // set focus to input field
    },
